#ifndef INPUT_DEFINITION_INCLUDED
#define INPUT_DEFINITION_INCLUDED
#include <SDL/SDL.h>

/// Represent all the keyboards keys
...
#endif //INPUT_DEFINITION_INCLUDED